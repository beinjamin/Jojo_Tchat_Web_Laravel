<template>
 ...
 <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form >
                <textarea ref="tweetTextarea" placeholder="Que se passe-t-il ?" class="rounded-lg border border-gray-200 w-full p-2 font-semibold resize-none focus:outline-none" v-model="content"></textarea>
